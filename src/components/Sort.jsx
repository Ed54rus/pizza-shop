...
const Sort = () => {
	...
	const sortName = sortList[activeSortName];

	const onClickSortName = (id) => {
		setActiveSortName(id);
	...
	return (
		<div className="sort">
			<div className="sort__label">
				...
				<b>Сортировка по:</b>
				<span onClick={() => setToggleSortPopup(!toggleSortPopup)}>{sortName}</span>
			</div>
			{toggleSortPopup && (
				<div className="sort__popup">
					<ul>
						{sortList.map((name, id) => (
							<li
								className={activeSortName === id ? "active" : ""}
